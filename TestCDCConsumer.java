...
public class TestCDCConsumer {
    ...
    public CompletableFuture<String> CDCBuilder() {
        ...
        GetConfigValue value = new GetConfigValue();
        String cdccontactpoint = value.GetCDCContactPoint();
        String cdckeyspace = value.GetCDCKeyspace();
        String cdctable = value.GetCDCTable();
